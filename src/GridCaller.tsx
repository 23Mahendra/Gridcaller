                      ...
                      <>
                        ...
                        {cd.devices.length <= 1 ? (
                          ...
                          cd.devices.map((d) => {
                            ...
                            const isActionable = !isSelf && !!d.id;
                                  ...
                                  {isActionable && (
                                    ...
                                    >
                                      <button
                                        ...
                                        title="Call"
                                        onClick={() => {
                                          void placeCallLocal(d.id, d.name);
                                        }}
                                        style={{
                                          width: 30,
                                          height: 30,
                                      ...
                                      <button
                                        ...
                                        title="Message"
                                        onClick={() => {
                                          const ex = sms.find((s) => s.peerId === d.id);
                                      ...
                                      <button
                                        ...
                                        title="Open chat"
                                        onClick={() => {
                                          const dmId = [MeshEngine.localId, d.id].sort().join("_");

                                          const ex = groupChats.find(
                                            (g) =>
                                              g.id === dmId ||
                                              (
                                                g.members.length === 2 &&
                                                g.members.includes(d.id) &&
                                                g.members.some((m) => isCallAddressedToMe(m))
                                              )
                                          );

                                          if (ex) {
                                            setGroupViewId(ex.id);
                                          } else {
                                            const ng = {
                                              id: dmId,
                                              name: d.name || d.id,
                                              members: [MeshEngine.localId, d.id],
                                              createdAt: Date.now(),
                                              updatedAt: Date.now(),
                                            };

                                            setGroupChats((prev) => [ng, ...prev]);
                                            setGroupViewId(dmId);
                                          }

                                          setTab("groups");
                                          setGridchatSubTab("chats");
                                          setGridchatPeopleTab("contacts");
                                        }}
                                        style={{
                                          width: 30,
                                          height: 30,
